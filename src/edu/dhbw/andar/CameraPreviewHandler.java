...
public class CameraPreviewHandler implements PreviewCallback {
    ...
    // TODO zxing injection. Set handler for barcode and message for handler
    private Handler previewHandler;
    private int previewMessage;
    private boolean zxingMode = false;
...
//            markerInfo.setVisListener(focusHandler);
    ...
    public synchronized void onPreviewFrame(byte[] data, Camera camera) {
        // TODO Roger's change. Here we will switch mode of scanning
        if(!zxingMode){
        ...
        if (zxingMode){
            ...
            Point cameraResolution = ZxingCameraManager.get().getConfigManager().getCameraResolution();
    ...
    // TODO zxing injection. Here we set handler for barcode scanner
    // TODO also we will need to set trigger that switchs mode barcode/marker
    public void setHandler(Handler previewHandler, int previewMessage) {
        this.previewHandler = previewHandler;
        this.previewMessage = previewMessage;
    }

    //TODO set method for switch
    public void switchTozxing(boolean mode){
        zxingMode = mode;
    }
