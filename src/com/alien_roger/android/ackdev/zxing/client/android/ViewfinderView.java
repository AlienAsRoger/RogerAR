...
public final class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        // TODO at this point we need to receive  coordinatets of frame
//        Rect frame = CameraManager.get().getFramingRect();
        // TODO hardcode here values, until we get camera singleton instance
        int left = 160;
        int bottom = 420;
        int right = 640;
        int top = 60;
...
//                             int left, int top, int right, int bottom)
        ...
        if (resultBitmap != null) {
            ...
            // TODO here we will draw image that we get from the server
...
//            Rect previewFrame = CameraManager.get().getFramingRectInPreview();
            Rect previewFrame = new Rect(left,top,right,bottom);
